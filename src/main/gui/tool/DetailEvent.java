...
public class DetailEvent extends EventObject {
    ...
    public String[] getDataArray() {
        ...
        res[2] = "Wuhan:" + overallResult.collectRegionalData("Wuhan",ss,days);
        res[3] = "SouthWest:" + overallResult.collectRegionalData("SouthWest",ss,days);
        res[4] = "SouthEast:" + overallResult.collectRegionalData("SouthEast",ss,days);
        res[0] = "NorthWest:" + overallResult.collectRegionalData("NorthWest",ss,days);
